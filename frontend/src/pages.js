...
export const LessonPage = () => {
  ...
  const [aiGeneratedDoodle, setAiGeneratedDoodle] = useState(null);
              ...
              <div className="space-y-8">
                ...
                <div className="bg-gradient-to-br from-indigo-100 to-purple-100 rounded-2xl p-8 border border-indigo-200">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    {/* Generate Developer Doodle - NEW FEATURE */}
                    <div className="bg-white rounded-xl p-6 border border-orange-200">
                      <h5 className="font-bold text-lg mb-3">🖊️ Developer Doodle</h5>
                      <p className="text-gray-600 mb-4">Generate raw whiteboard-style sketches like a dev thinking through the problem</p>
                      <button
                        onClick={generateDeveloperDoodle}
                        disabled={generatingDoodle}
                        className="w-full bg-gradient-to-r from-orange-600 to-red-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-orange-700 hover:to-red-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        {generatingDoodle ? (
                          <span className="flex items-center justify-center">
                            <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-white" fill="none" viewBox="0 0 24 24">
